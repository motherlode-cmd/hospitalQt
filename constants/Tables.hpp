...
const QMap<ElementType, QStringList> tableLabels{
    ...
    {ElementType::Employees, {"id", "personnel_number", "last_name", "first_name", "middle_name", "address_city", "address_street", "address_house", "address_apartment", "phone", "birth_date", "gender", "passport_series", "passport_number", "position", "current_salary", "pay_rate", "hours_per_week", "payment_frequency", "contract_type", "ward_id"}},
    {ElementType::Employee_qualifications, {"id", "employee_id", "qualification_type", "qualification_date", "institution_name"}},
    {ElementType::Employee_experience, {"id", "employee_id", "organization_name", "position", "start_date", "end_date"}},
    {ElementType::Work_schedules, {"id", "employee_id", "ward_id", "shift_date", "shift_type"}},
    {ElementType::Patients, {"id", "patient_number", "last_name", "first_name", "middle_name", "address_city", "address_street", "address_house", "address_apartment", "phone", "birth_date", "gender", "marital_status", "registration_date"}},
    {ElementType::Patient_relatives, {"id", "patient_id", "last_name", "first_name", "middle_name", "relationship", "address_city", "address_street", "address_house", "address_apartment", "phone"}},
    {ElementType::District_doctors, {"id", "last_name", "first_name", "middle_name", "clinic_name", "address_city", "address_street", "address_house", "address_apartment", "phone"}},
    {ElementType::Appointments, {"id", "patient_id", "district_doctor_id", "consultant_last_name", "consultant_first_name", "consultant_middle_name", "consultant_personnel_number", "appointment_date", "room_number", "recommendation"}},
    {ElementType::Outpatient_patients, {"id", "patient_id", "appointment_date"}},
    {ElementType::Inpatient_patients, {"id", "patient_id", "ward_id", "bed_number", "queue_registration_date", "assigned_ward_id", "expected_treatment_days", "placement_date", "expected_discharge_date", "actual_discharge_date"}},
    {ElementType::Medications, {"id", "medication_code", "name", "description", "dosage", "administration_method", "stock_quantity", "reorder_level", "unit_cost"}},
    {ElementType::Prescribed_medications, {"id", "patient_id", "medication_id", "ward_id", "daily_dosage", "administration_method", "start_date", "end_date"}},
