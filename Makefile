#############################################################################
# Makefile for building: hospital.app/Contents/MacOS/hospital
# Generated by qmake (3.1) (Qt 6.9.0)
# Project:  hospital.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile hospital.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = hospital1.0.0
DISTDIR = /Users/oksanafedorova/lab6_Ars/.tmp/hospital1.0.0
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		hospital.pro Forms/formcomplant.h \
		...
		main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = hospital
DESTDIR       = 
TARGET        = hospital.app/Contents/MacOS/hospital

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 14.4
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/oksanafedorova/lab6_Ars/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/oksanafedorova/lab6_Ars/hospital.pro
...
hospital.app/Contents/MacOS/hospital: ui_formcomplant.h ui_mainwindow.h $(OBJECTS)  
	@test -d hospital.app/Contents/MacOS/ || mkdir -p hospital.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: hospital.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/macx.conf \
...
hospital.app/Contents/PkgInfo: 
	@test -d hospital.app/Contents || mkdir -p hospital.app/Contents
	@$(DEL_FILE) hospital.app/Contents/PkgInfo
	@echo "APPL????" > hospital.app/Contents/PkgInfo
hospital.app/Contents/Info.plist: 
	@test -d hospital.app/Contents || mkdir -p hospital.app/Contents
	@$(DEL_FILE) hospital.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.hospital,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.hospital,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,hospital,g" -e "s,@LIBRARY@,hospital,g" -e "s,\$${EXECUTABLE_NAME},hospital,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >hospital.app/Contents/Info.plist

all: Makefile \
		hospital.app/Contents/PkgInfo \
		hospital.app/Contents/Info.plist hospital.app/Contents/MacOS/hospital
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Forms/formcomplant.h QtModels/QTableModel.h QtModels/QtModels.hpp Models/Models.hpp mainwindow.h $(DISTDIR)/
	$(COPY_FILE) --parents Forms/formcomplant.cpp QtModels/QTableModel.cpp QtModels/QtModels.cpp Models/Models.cpp main.cpp mainwindow.cpp $(DISTDIR)/
	$(COPY_FILE) --parents Forms/formcomplant.ui mainwindow.ui $(DISTDIR)/
...
compiler_moc_header_make_all: moc_formcomplant.cpp moc_QTableModel.cpp moc_QtModels.cpp moc_mainwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_formcomplant.cpp moc_QTableModel.cpp moc_QtModels.cpp moc_mainwindow.cpp
...
compiler_uic_make_all: ui_formcomplant.h ui_mainwindow.h
compiler_uic_clean:
	-$(DEL_FILE) ui_formcomplant.h ui_mainwindow.h
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/hospital/bin || mkdir -p $(INSTALL_ROOT)/opt/hospital/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/hospital/bin/hospital.app
	
	$(QINSTALL) hospital.app $(INSTALL_ROOT)/opt/hospital/bin/hospital.app
	-$(STRIP) $(INSTALL_ROOT)/opt/hospital/bin/hospital.app/Contents/MacOS/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/hospital/bin/hospital.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/hospital/bin/ 
